...
class AutorController extends Zend_Controller_Action
{
	public function init()
	{
		...
		$this->facade = FernandoMantoan_DesignPatterns_Factory_FactoryFacade::createInstance(FernandoMantoan_DesignPatterns_Factory_FactoryFacade::FACADE_AUTHOR);
	}
